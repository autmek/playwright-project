...
// Constants
const newtitle = 'NEW BestSeller - 404';
...
// 1. Create new Widget
test('Create new BestSeller widget for 404 page',{tag:'@CreateNewWidget'}, async()=>{
    ...
    fs.writeFileSync(path.resolve(__dirname, 'Bestseller404.json'), JSON.stringify({ widgetID }));
